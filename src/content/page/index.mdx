...
description: "a"
intro: "We envision a world where the wonders of the universe are accessible to everyone, where curiosity about the cosmos is celebrated, and where astronomy education serves as a gateway to broader scientific literacy and a deeper understanding of our place in the cosmos."
hero_template: image
template: full
container: md
hero_buttons:
...
blocks:
  ...
  - type: text_image
    ...
    thumbnail: /src/assets/Astronomy Made Easy_merch.jpeg
    buttons:
      - icon_only: false
        label: Demo Shop
        href: /shop
  ...
  - type: rich_text
    ...
    container: sm
    content: >
      ## Astronomy Made Easy Portfolio


      Need to show your skills, select a good template and build your portfolio with Astronomy Made Easy.
    buttons:
      - icon_only: false
  ...
  - type: text_image
    ...
    content: >+
      ## Astronomy Made Easy Restaurant Menus
...
og_image: /src/assets/og_image_Astronomy Made Easy.png
---
